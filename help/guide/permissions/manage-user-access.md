...
若要授與使用者存取Real-Time CDP Collaboration的許可權，您可以使用稱為角色的存取控制概念。 角色定義系統管理員或使用者對貴組織中[資源](https://experienceleague.adobe.com/en/docs/experience-platform/access-control/home#permissions)的存取層級。
