...
使用行銷動作來控制要從Experience Platform將哪些對象資料帶入Collaboration。 **[!UICONTROL 資料協作]**&#x200B;行銷動作支援 C4、C5、C9、S1、S2、PSPD 和 RHD 資料使用情況標籤。 **[!UICONTROL 資料科學]**&#x200B;行銷動作支援 C9 資料使用情況標籤。

深入瞭解[C4、C5、C9、S1、S2、PSPD與RHD資料使用標籤](https://experienceleague.adobe.com/en/docs/experience-platform/data-governance/labels/reference#contract){target="_blank"}。
