...
>title="從 Google Cloud Storage 新增客群"
>abstract="若要連接您的 Google Cloud Storage，請授權 Adobe 的服務使用者檢索客群資料以進行處理。 請依照 Experience League 中概述的步驟，授予 Adobe 您的 Google Cloud Storage 存取權。"
