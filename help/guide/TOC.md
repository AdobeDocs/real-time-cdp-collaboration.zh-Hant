...
* [Real-Time CDP Collaboration 首頁](./home.md)
...
* 設定 {#setup}
  ...
  * {hide-from-toc}[對象總覽](./setup/audiences-overview.md)
  * Source和管理對象 {#source-audiences}
    * [來源概觀](./setup/source-overview.md)
    * [設定AEP以取得對象](./setup/onboard-audiences.md)
    * [設定對象來源的AWS許可權](./setup/configure-aws-permissions-audience-sourcing.md)
    * [設定Azure儲存空間以取得對象來源](./setup/configure-azure-storage-audience-sourcing.md)
    * [設定Amazon S3以取得對象](./setup/configure-aws-s3-audience-sourcing.md)
    ...
    * [設定Adobe Audience Manager以取得對象](./setup/configure-aam-audience-sourcing.md)
  * [管理資料連線](./setup/manage-data-connection.md)
  * [追蹤您的點數耗用活動](/help/guide/setup/my-activity.md)
  * {hide-from-toc}[身分交叉通道](./setup/identity-crosswalk.md)
  * [新增及管理測量資料](./setup/onboard-measurement-data.md)
  * [管理測量資料連線](./setup/manage-measurement-data-connection.md)
  * [稽核記錄](./setup/audit-logs.md)
  * Real-Time CDP Collaboration入門設定 {#starter-setup}
    * [設定管理員存取權](./setup/starter-admin-access.md)
    * [設定許可權控制項](./setup/starter-permission-controls.md)
    * [信用使用量和消耗量](./setup/starter-credit-usage.md)
* 建立連線 {#connect}
  * [概觀](/help/guide/connect/overview.md)
  ...
  * Advertising平台連線 {#ad-platform-connections}
    * [概觀](/help/guide/connect/advertising-platforms/overview.md)
    * [Amazon Marketing Cloud](./connect/advertising-platforms/amc.md)
* 協作 {#collaborate}
  * [概觀](/help/guide/collaborate/overview.md)
  ...
  * Advertising平台連線 {#ad-platform-connections}
    ...
    * {hide-from-toc}[建立AMC測量報告](./collaborate/advertising-platforms/amc-measure.md)
* 目的地 {#destinations}
  * [概觀](/help/guide/destinations/overview.md)
  * [設定和管理雲端儲存空間目的地](./destinations/manage-destinations.md)
  * [雲端儲存空間目的地需求](./destinations/cloud-storage-destination-requirements.md)
  * [將Adobe Experience Platform設定為目的地](./destinations/experience-platform.md)
* 權限 {#permissions}
