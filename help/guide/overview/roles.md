...
若要更清楚瞭解角色、不同共同作業模式及使用方式，請參閱[共同作業模式](/help/guide/overview/collaboration-patterns.md)指南。 我們的[端對端工作流程](/help/guide/overview/end-to-end-workflow.md)指南會強調每個共同作業模式，並透過品牌角度提供Collaboration產品的一般概觀。
