...
連線要求是從一個組織傳送給另一個組織的正式要求，以建立資料共用連線。 一旦接受，它可讓雙方安全地共同作業及共用受眾資料。
...
Adobe Real-Time CDP Collaboration中的邀請是指傳送給其他使用者或組織加入專案或資料共同作業的要求。 邀請協助促進對共用資料與資源的安全且受控制的存取。
...
發佈商是線上內容或服務的擁有者或營運商，其個人資料在同意下收集，並可由其他實體用於數位廣告和受眾測量。
